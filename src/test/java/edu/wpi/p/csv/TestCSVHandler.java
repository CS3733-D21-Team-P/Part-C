...
public class TestCSVHandler {
    ...
    public static void setup() throws IOException {
        ...
        try {
            simpleCSV = CSVHandler.readCSVFile(simpleCSVFile.toPath().toString());
        }
        catch (Exception e) {
        ...
        try {
            typesCSV = CSVHandler.readCSVFile(typesCSVFile.toPath().toString());
        }
        catch (Exception e) {
    ...
    public void testExceptionBroken() throws IOException{
        ...
        Exception e = assertThrows(Exception.class, () -> {
            CSVHandler.readCSVFile(brokenCSVFile.toPath().toString());});
    }
